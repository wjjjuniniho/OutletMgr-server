...
public class MerchandiseDetailListServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public MerchandiseDetailListServlet() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		JSONArray itemDetailJSONArray = null;
			...
			if (queryParamList != null) {
				...
				if (storeId != null && !storeId.equals("")) {
					...
					if (itemDetailObjectList.get(0).isSuccessful()) {
						itemDetailJSONArray = MerchandiseDetailListHelper
								.toJSONArray(itemDetailObjectList);
		...
		out = response.getWriter();
		if (itemDetailJSONArray != null) {
			out.write(itemDetailJSONArray.toString());
		}
		out.flush();
		out.close();
	}
